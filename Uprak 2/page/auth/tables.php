    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Kasir <sup>2</sup></div>
            </a>
...
$query_total = "SELECT COUNT(*) as total FROM spp";
...
echo "<thead>";
echo "<tr><th>No</th><th>Tahun</th><th>Nominal</th></tr>";
echo "</thead>";
echo "<tbody>";
...
echo "<a href='../../page/buku/index.php' class='btn btn-success btn-lg-col-7'>tambah data</a>";
